/**
  ...
  * @brief   MX25UM51245G OctoSPI NOR memory configuration file.
  *          Copied from mx25um51245g_conf_template.h (include adapted to
  *          stm32u5xx_hal.h, as in the official STM32U5x9J-DK BSP example).
  ******************************************************************************
  * @attention
  *
